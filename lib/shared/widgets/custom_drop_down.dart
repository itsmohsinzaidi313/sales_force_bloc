...
class DropDown extends StatefulWidget {
  ...
  @override
  _DropDownState createState() => _DropDownState(itemHeight: this.itemHeight);
}

class _DropDownState extends State<DropDown> {
  final double itemHeight;

  _DropDownState({this.itemHeight});
